...
#define DEFAULT_MAXIMUM_DOWNLOAD_LIMIT_PER_USER 1
#define DEFAULT_MAXIMUM_UPLOAD_LIMIT_PER_USER 1
#define DEFAULT_MINIMUM_DOWNLOAD_LIMIT_PER_USER 1
#define DEFAULT_MINIMUM_UPLOAD_LIMIT_PER_USER 1
#define DEFAULT_MAXIMUM_DATA_CONSUMED_BEFORE_REDUCE_SPEED 0
#define DEFAULT_MAXIMUM_DATA_CONSUMED_BEFORE_DISCONNECT 0
